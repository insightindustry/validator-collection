...
version_dict = {}
with open(path.join(here, 'validator_collection', '_version.py'),
...
setup(
    ...
    name='validator-collection',  # Required
    ...
    url='https://github.com/insightindustry/validator-collection',  # Optional
    ...
    keywords='validator validate validation validators',  # Optional
